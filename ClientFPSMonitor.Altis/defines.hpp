...
#define UI_GRID_X GUI_GRID_X
#define UI_GRID_Y GUI_GRID_Y
#define UI_GRID_W (pixelW * pixelGrid) // One grid width 0.0119048
#define UI_GRID_H (pixelH * pixelGrid) // One grid height 0.015873
...
class RscTitleBackground: RscTitle
{
	colorBackground[]=
	{
